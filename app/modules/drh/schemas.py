...
_UPPERCASE_FIELDS = {
    ...
    "birth_place", "commune", "wilaya", "position", "desired_position",
    "society", "contract_type", "family_status", "nin", "code",
}


class _UpperMixin(BaseModel):
    @model_validator(mode="before")
    @classmethod
    def _normalize_uppercase(cls, data: Any) -> Any:
...
class EmployeeBase(_UpperMixin):
...
class CandidateBase(_UpperMixin):
    first_name: str
    last_name: str
    phone: str | None = None
    email: str | None = None
...
class ContractBase(_UpperMixin):
    employee_id: int
    contract_type: str = ""
    position: str | None = None
