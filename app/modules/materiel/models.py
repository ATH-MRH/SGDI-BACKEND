...
class StockArticle(Base, TimestampMixin):
    ...
    useful_life_months: Mapped[float] = mapped_column(Float, default=0)
    min_quantity: Mapped[float] = mapped_column(Float, default=0)
    item_state: Mapped[str] = mapped_column(String(40), default="neuf", index=True)
...
class StockMovement(Base, TimestampMixin):
    ...
    target_label: Mapped[str | None] = mapped_column(String(180))
    structure: Mapped[str | None] = mapped_column(String(150), index=True)
    item_state: Mapped[str | None] = mapped_column(String(40), index=True)
    useful_life_months: Mapped[float] = mapped_column(Float, default=0)
...
class EmployeeEquipment(Base, TimestampMixin):
    ...
    voucher_number: Mapped[str | None] = mapped_column(String(120))
    item_state: Mapped[str | None] = mapped_column(String(40), default="neuf", index=True)
    useful_life_months: Mapped[float] = mapped_column(Float, default=0)
...
class MaterialAssignment(Base, TimestampMixin):
