 ...
 */
import { ApiClient, createAuthApi, createReferenceApi, createIncidentsApi, createCandidatesApi, createEmployeesApi, createDrhApi } from '@sgdi/shared';
...
export const drhApi = createDrhApi(apiClient);
