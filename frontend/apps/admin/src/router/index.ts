...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'fiches', name: 'fiches-position', component: () => import('@/pages/effectif/FichesPosition.vue') },
      { path: 'fiches/:sub', name: 'fiches-position-sub', component: () => import('@/pages/effectif/FichesPosition.vue') },
      { path: 'admin/fiches', name: 'admin-fiches', component: () => import('@/pages/effectif/FichesPosition.vue') },
